...
python2 ./src/rcnn_fc_softmax.py data/training_model_by_word2vec_1.vector data/train_feature ./data/train_label \
 ./data/test_feature ./data/test_label ./data/train_lstm_output.npy ./data/test_lstm_output.npy 
'''
...
MAX_LENGTH = 50
BATCH_SIZE = 256
PROTOTYPE_NUM = 50 ## len(rule_dict)
...
output2 = output2.data 
output2 = np.array(output2)
np.save(sys.argv[6], output2)
###  save  train data
######################################################
###### save  test data
save_lstm_output_for_testdata(nnet, test_data_dict, test_label, sys.argv[7])
###### save  test data
